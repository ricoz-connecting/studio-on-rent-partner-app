...
class Sell extends ConsumerStatefulWidget {
  final Studio? studio;
  final bool? isEdit, disableTextField;
...
class _SellState extends ConsumerState<Sell> {
  ...
  void initState() {
    ...
    if (widget.studio != null) {
      ...
      _priceController.text = widget.studio!.price![0].amount.toString();
      ...
      setState(() {
        ...
        isFreeCancelSelected = widget.studio!.facility!.contains('Free cancel');
                      ...
                      children: [
                        ...
                        if (!widget.disableTextField!)
                          AddStudioRequestButton(
                            label:
                                widget.isEdit! ? 'Update Studio' : 'Add Studio',
                            onTap: () {
                              Location locationFromLatLng(
                                  LatLng? selectedLocation) {
