...
// class ChatScreenPartner extends ConsumerStatefulWidget {
//   final String partnerId;
//   final String userId;

//   const ChatScreenPartner(
//       {Key? key, required this.partnerId, required this.userId})
//       : super(key: key);

//   @override
//   _ChatScreenPartnerState createState() => _ChatScreenPartnerState();
// }

// class _ChatScreenPartnerState extends ConsumerState<ChatScreenPartner> {
...
//     print("ChatRoom ID: $chatRoomId"); // Debugging
...
//           chatRoomId!,
//           widget.partnerId, // Ensure correct sender ID
//           widget.userId,
//           text,
//         );
//     ref.read(chatControllerProvider.notifier).sendMessage(
...
//                   subtitle: Text(
//                       message.senderId == widget.partnerId ? "You" : "User"),
//                   trailing: message.senderId == widget.partnerId
//                       ? Icon(Icons.check)
//                       : null,
//                 );
//               },
...
//           if (isTyping)
//             Padding(
//                 padding: EdgeInsets.all(8.0), child: Text("User is typing...")),
//           Padding(
...
//                           chatRoomId!, widget.partnerId, text.isNotEmpty);
//                     },
...
class _ChatScreenPartnerState extends ConsumerState<ChatScreenPartner> {
  ...
  void _onMessageReceived(Map<String, dynamic> message) {
    ...
    ref.read(chatControllerProvider.notifier).updateChatList(newMessage);
    _scrollToBottom();
  }
        ...
        children: [
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final message = messages[index];
                final bool isSentByUser = message.senderId == widget.partnerId;
          ...
          Expanded(
            child: TextField(
              ...
              onChanged: (text) {
                final socket = ref.read(socketServiceProvider);
                if (text.isNotEmpty) {
                  socket.typingEvent(chatRoomId!, widget.partnerId, true);
                } else {
                  socket.typingEvent(chatRoomId!, widget.partnerId, false);
                }
              },
