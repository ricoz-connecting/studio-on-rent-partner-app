...
class ReusableStudioCard extends StatefulWidget {
  final String title;
  ...
  @override
  State<ReusableStudioCard> createState() => _StudioCardState();
}

class _StudioCardState extends State<ReusableStudioCard> {
  int _currentIndex = 0;
  late Timer _timer;
