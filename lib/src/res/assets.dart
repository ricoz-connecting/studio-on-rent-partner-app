...
class ImageAssets {
  ...
  static const addimage = "$_baseIconPath/add-image.png";
  static const chatBubble = "$_baseIconPath/chat.png";
  static const editIcon = '$_baseIconPath/edit-outline.png';
  ...
  static const verficationWaiting = "$_base/verification-waiting.png";
  ...
  static const raiseTicket = "$_base/ticket.png";

  static const privacyIcon = "$_base/privacy_icon.svg";

  //bottom nav bar items
  static const home = "$_baseIconPath/home.svg";
  static const createStudio = "$_baseIconPath/create-studio.svg";
  static const wallet = "$_baseIconPath/wallets.svg";
  static const stores = "$_baseIconPath/stores.svg";
